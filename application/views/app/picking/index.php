...
<script src="<?= PATH_PUBLIC_JS.'/app/app.picking.js' ?>"></script>
<script src="<?= PATH_PUBLIC_JS.'/app/app.cellar.picking.js' ?>"></script>
<main class="mn-inner">
		...
		<div class="col s12">
			<div class="card">
				<div class="card-content">
					<span class="card-title">Cosechar</span>
					<div class="row">
            ...
            <div class="col s6 m6 l6" style="text-align: right;">
              <a class="waves-effect waves-light btn red darken-3" onclick="forcedPicking()" id="forced"><i class="material-icons left">refresh</i>Forzar</a>
            </div>
