                                ...
                                <form class="col s12 m12 l12" id="fmstore">
                                    <div class="row">
                                        ...
                                        <div class="input-field col s12 m12 l6">
                                            <div class="switch m-b-md">
                                                <label>
                                                    Pedido Por Boleta
                                                    <input type="checkbox" value="1" name="tped" id="tped"
                                                           checked="true">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12 m6 l4">
                                            ...
                                            <a href="javascript:void(0)" onclick="openModal5()" id="msii"
                                               style="display: none;">Ver Actividades Para Seleccionar Giro</a>
                                        </div>
                                        <div class="input-field col s12 m6 l4">
                                            <input id="nstore" name="nstore" type="text" placeholder=""
                                                   class="validate">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12 m6 l4">
                                            <select name="ccost" id="ccost" class="js-states browser-default"
                                                    style="width: 100%">
                                                <option value="" disabled="" selected=""></option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field col s12 m6 l4 div-hidden">
                                            <input id="ramal_hiddden" name="ramal_hiddden" type="hidden" placeholder=""
                                                   class="validate">
                                            <input id="costo_hiddden" name="costo_hiddden" type="hidden" placeholder=""
                                                   class="validate">
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div id="area-softlan" style="display: none;">
                                        <div class="row">
                                            ...
                                            <div class="input-field col s12 m12 l6">
                                                <input id="_razon_real" name="_razon_real" type="text" placeholder=""
                                                       class="validate">

                                                <label for="dirfact">Razón Social</label>
                                            </div>
                                            <div class="input-field col s12 m12 l6">
                                                <input id="dirfact" name="dirfact" type="text" placeholder=""
                                                       class="validate">
                                                <input id="savesoft" name="savesoft" value="saved" type="text"
                                                       class="validate" readonly="true">
                                                <label for="dirfact">Dirección de Facturación</label>
                                            </div>
                                            <div class="input-field col s12 m12 l6">
                                                <input id="dirdesp" name="dirdesp" type="text" placeholder=""
                                                       class="validate">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m12 l6">
                                                <input id="emailcontacto" name="emailcontacto" type="text"
                                                       placeholder="" class="validate">
                                                <label for="emailcontacto">Email de Contacto</label>
                                            </div>
                                            <div class="input-field col s12 m12 l6">
                                                <input id="emaildte" name="emaildte" type="text" placeholder=""
                                                       class="validate">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m12 l6">
                                                <select name="giro" id="giro" class="js-states browser-default"
                                                        style="width: 100%">
                                                    <option value="" disabled="" selected=""></option>
                                            ...
                                            <div class="input-field col s12 m12 l6">
                                                <select name="pais" id="pais" class="js-states browser-default"
                                                        style="width: 100%">
                                                    <option value="" disabled="" selected=""></option>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m12 l6">
                                                <select name="region" id="region" class="js-states browser-default"
                                                        style="width: 100%">
                                                    <option value="" disabled="" selected=""></option>
                                            ...
                                            <div class="input-field col s12 m12 l6">
                                                <select name="ciudad" id="ciudad" class="js-states browser-default"
                                                        style="width: 100%">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m12 l6">
                                                <select name="comuna" id="comuna" class="js-states browser-default"
                                                        style="width: 100%">
                                                    <option value="" disabled="" selected=""></option>
                                    ...
                                    <div class="row">
                                        <button id="save_store" type="submit"
                            ...
                            <div class="row">
                                <form class="col s12 m12 l12" id="fmuser">
                                    <div class="row">
                                        ...
                                        <div class="input-field col s12 m6 l4">
                                            <select name="store_id" id="store_id" class="js-states browser-default"
                                                    style="width: 100%">
                                                <option value="" disabled="" selected=""></option>
                                        ...
                                        <div class="input-field col s12 m6 l4">
                                            ...
                                            <input id="rewrite" name="rewrite" type="hidden" placeholder=""
                                                   class="validate" readonly="true">
                                        ...
                                        <div class="input-field col s12 m6 l4">
                                            ...
                                            <div id="loader7"></div>
                                            <a href="javascript: void(0)" id="gnp"><i
                                                        class="tiny material-icons">build</i> <?= lang("app_user_myaccount_title3") ?>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="input-field col s12 m6 l4">
                                            <select name="storetp" id="storetp" class="js-states browser-default"
                                                    style="width: 100%">
                                                <option value="" disabled="" selected=""></option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field col s12 m6 l4">
                                            <select name="key" id="key" class="js-states browser-default"
                                                    style="width: 100%">
                                                <option value="" disabled="" selected=""></option>
                                        ...
                                        <div class="input-field col s12 m6 l4">
                                            <select name="ubicacion" id="ubicacion" class="js-states browser-default"
                                                    style="width: 100%">
                                                <option value="" disabled="" selected=""></option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field col s12 m12 l3">
                                            <div class="switch m-b-md">
                                                <label>
                                                    <input type="checkbox" value="1" name="emfp" id="emfp"
                                                           checked="true">
                                                    <span class="lever"></span>
                                                    Enviar Fact. Pedidos
                                                </label>
                                        ...
                                        <div class="input-field col s12 m12 l3">
                                            <div class="switch m-b-md">
                                                <label>
                                                    <input type="checkbox" value="1" name="emex" id="emex"
                                                           checked="true">
                                                    <span class="lever"></span>
                                                    Enviar Excel
                                                </label>
                                    ...
                                    <div class="row">
                                        <button id="save_user_new" type="submit"
                                                class="btn-floating btn-large waves-effect waves-light teal lighten-2">
                                            <i class="material-icons">save</i></button>
                                        <div id="loader3"></div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <form id="fmfile" class="p-v-xs" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="file-field input-field col s12 m6 l6">
                                        <div class="btn teal lighten-1">
                                            ...
                                            <input type="file"
                                                   ...
                                                   name="file" id="file" onchange="onLoadFile(event)">
                                        </div>
                                        <div class="file-path-wrapper">
                                            <input class="file-path validate valid" type="text">
                                        </div>
                                    </div>
                                    <button id="upload-button" type="submit" onclick="return false;"
                                            class="btn-floating btn-large waves-effect waves-light teal lighten-2">
                                    ...
                                    <div id="loader10">
                                        <div id="porcent"></div>
                                        <div class="progress">
                                            <div class="determinate" style="width: 0%" id="process"></div>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <form class="col s12 m12 l12" id="fmlistp">
                                    <div class="row">
                                        <div class="input-field col s12 m6 l5">
                                            <select name="store_id_3" id="store_id_3" class="js-states browser-default"
                                                    style="width: 100%">
                                                <option value="" disabled="" selected=""></option>
                                                <?php foreach (json_decode($listStoreActive) as $key => $value): ?>
                                                    <option value="<?= $value->id_tienda ?>"><?= sprintf("%05d", $value->id_tienda) . " - " . $value->nombre_tienda ?></option>
                                        ...
                                        <div class="input-field col s12 m6 l5">
                                            <select name="store_id_4" id="store_id_4" class="js-states browser-default"
                                                    style="width: 100%">
                                                <option value="" disabled="" selected=""></option>
                                                <?php foreach (json_decode($listStoreActive) as $key => $value): ?>
                                                    <option value="<?= $value->id_tienda ?>"><?= sprintf("%05d", $value->id_tienda) . " - " . $value->nombre_tienda ?></option>
                                        ...
                                        <div class="input-field col s12 m6 l2">
                                            <button id="save_list_new" type="submit"
                                                    class="btn-floating btn-large waves-effect waves-light teal lighten-2"
                                                    title="Transferencia entre clientes" t>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="row left-text">
                                            <div class="input-field col s12 m4 l4">
                                                <input id="codproduct" name="codproduct" type="text" placeholder=""
                                                       class="validate" readonly="true">
                                            ...
                                            <div class="input-field col s12 m6 l6">
                                                <input id="price_new" name="price_new" value="empty" type="text"
                                                       style="display: none;" placeholder="Nuevo Precio">
                                                <p class="range-field">
                                                    <input id="range" min="0" max="100" class="active" type="range"
                                                           value="0" style="display: none;"><span class="thumb"
                                                                                                  style="left: 219.5px; height: 0px; width: 0px; top: 10px; margin-left: -6px;"><span
                                        ...
                                        <div class="row left-text">
                                            ...
                                            <div class="input-field col s12 m12 l6">
                                                <div class="switch m-b-md">
                                                    <label>
                                                        Disminuir %
                                                        <input type="checkbox" value="1" name="factor" id="factor"
                                                               disabled="">
                                                        <span class="lever"></span>
                                                        Aumentar %
                                                    </label>
                                                ...
                                                <br>
                                                <br>
                                                <h6 class="red-text">*Aumentar o Diminuir Porcentaje de precio de
                                                    venta</h6>
                                            </div>
                                            ...
                                            <div class="input-field col s12 m12 l12">
                                                <textarea id="obs" name="obs" class="materialize-textarea"
                                                          length="120"></textarea>
                                        ...
                                        <div class="input-field col s12 m12 l12 right-text">
                                            <button id="inprice"
                                                    class="btn waves-effect waves-light btn yellow darken-2"
                                                    title="buscar informacion de tienda">Incluir en Tienda
                                            </button>
                            ...
                            <div>
                                <div id="modal2" class="modal">
                                    <div class="modal-content">
                                        ...
                                        <div class="row left-text">
                                            <div class="input-field col s12 m4 l4">
                                                <input id="codproduct2" name="codproduct2" type="text" placeholder=""
                                                       class="validate" readonly="true">
                                                <label for="codproduct">Producto</label>
                                            </div>
                                            <div class="input-field col s12 m8 l8">
                                                <input id="product2" name="product2" type="text" placeholder=""
                                                       class="validate" readonly="true">
                                                <label for="product">Producto</label>
                                            </div>
                                            <div class="input-field col s12 m6 l6">
                                                <input id="price2" name="price2" type="text" placeholder=""
                                                       class="validate" readonly="true">
                                                <label for="price">Precio</label>
                                            </div>

                                            <div class="input-field col s12 m6 l6">
                                                <input id="price_new2" name="price_new2" value="empty" type="text"
                                                       style="display: none;" placeholder="Nuevo Precio">
                                                <p class="range-field">
                                                    <input id="range2" min="0" max="100" class="active" type="range"
                                                           value="0" style="display: none;"><span class="thumb"
                                                                                                  style="left: 219.5px; height: 0px; width: 0px; top: 10px; margin-left: -6px;"><span
                                                                class="value">0</span></span>
                                                </p>
                                        ...
                                        <div class="row left-text">
                                            <div class="input-field col s12 m12 l6">
                                                <div class="switch m-b-md">
                                                    <label>
                                                        <input type="checkbox" value="1" name="actprice2"
                                                               id="actprice2">
                                                        <span class="lever"></span>
                                                        Ajustar Precio
                                                    </label>
                                            ...
                                            <div class="input-field col s12 m12 l6">
                                                <div class="switch m-b-md">
                                                    <label>
                                                        Disminuir %
                                                        <input type="checkbox" value="1" name="factor2" id="factor2"
                                                               disabled="">
                                                        <span class="lever"></span>
                                                        Aumentar %
                                                    </label>
                                            ...
                                            <br>
                                            <div class="input-field col s12 m12 l12">
                                                <textarea id="obs2" name="obs2" class="materialize-textarea"
                                                          length="120"></textarea>
                                                <label for="textarea1" class="">Observación</label>
                                                <span class="character-counter"
                                                      style="float: right; font-size: 12px; height: 1px;"></span>
