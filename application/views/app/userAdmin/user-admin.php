			...
			<div id="list" class="col s12">
				<div class="card">
					<div class="card-content">
						<div class="row">
							<div class="col s12 m12 l12">
								<a class="waves-effect waves-light btn right-text" id="link-new-user"><i class="material-icons left">group_add</i><?= lang('app_useradmin_button1') ?></a>
								<br>
								<br>
							</div>
							<div class="col s12 m12 l12">
						...
						<div class="modal-content">
							...
							<form method="post" action="asigned-store-user" class="col s6 m12 l12" id="fastore">
								...
								<div class="row">
									...
									<button id="save_info" type="submit" class="btn btn-small waves-effect waves-light light-green">Asignar </button>
									<div id="loader5"></div>
