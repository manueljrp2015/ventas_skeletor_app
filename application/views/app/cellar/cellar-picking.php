		...
		<div class="col s12">
			<div class="card">
				<div class="card-content">
					<span class="card-title">Cosechador</span>
					<div class="row">
						<div class="col s12">
							<ul class="tabs tab-demo z-depth-1" style="width: 100%;">
								<li class="tab col s3"><a href="#test4">Cosechar</a></li>
							</ul>
						</div>
							...
							<p class="p-v-sm">
								<div class="row">
									<div class="input-field col s12 m6 l4">
										<select name="_store_pick" id="_store_pick" class="js-states browser-default" style="width: 100%">
