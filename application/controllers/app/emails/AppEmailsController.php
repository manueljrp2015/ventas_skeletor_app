...
* 
*/
class appEmailsController extends CI_Controller
{

	private $header;
	private $footer;
	private $colortop = "#00acc1";
									...
									<div class="content">
										<table bgcolor="'.$this->colortop.'" >
											<tr>
												...
												<td align="right"><h6 class="collapse" style="color: white">'.NAME_SITE.'</h6></td>
											</tr>
										</table>
										</div><!-- /content -->
	...
	{
		$this->email->from('system@mrdevelopers.com.ve', NAME_SITE);
        $this->email->to($email);
	...
	{
		$this->appEmailsModel->mailCreateStoreUser(["nombre" => "Simon Alarcon"]);
	}
