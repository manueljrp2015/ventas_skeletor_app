                        ...
                        if (response.data.msg == "badrut") {
                            ...
                            jQuery.getJSON('https://siichile.herokuapp.com/consulta', {
                                ...
                                if (result.actividades.length > 0) {
                                    ...
                                    $("#nstore").val("").val(result.razon_social);
                                    $("#msg-cli").empty().append('<label class="green-text">Este RUT se encuentra en nuestra base de datos asociado a una tienda y posee información de inicio de actividades en SII pero de igual forma puede continuar con el registro sin incluir información adicional.</label>')
                                    $("#area-softlan").attr('style', 'display: none;');
                                    ...
                                    $.each(result.actividades, function(index, val) {
                                        ...
                                        tbps += '<tr>' +
                                            '<td align="center"><a href="javascript: void(0)" onclick="selGiro(' + val.codigo + ')">' + val.codigo + '</a></td>' +
                                            '<td align="center">' + val.giro + '</td>' +
                                            '<td align="center">' + val.categoria + '</td>' +
                                            '<td align="center">' + afecta + '</td>' +
                                            '</tr>';
                                    });
                                    ...
                                    if ($("#tped").is(':checked')) {
                                        ...
                                        $("#savesoft").val("");
                                        $("#msii").attr('style', 'display: none;');
                                        swal("SII Chile", "Este RUT no tiene inicio de actividades en el Servicio de Inpuestos Internos SII.", "info");
                                    }
